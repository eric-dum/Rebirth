...
class WDI_Notices {
  ...
  protected $plugin_version = "wd_wdi_version";
  protected $plugin_name = 'Instagram WD';
  ...
  public function wd_admin_notices() {
    ...
    $notices['two_week_review'] = array(
      ...
      'link' => '<li><span class="dashicons dashicons-external"></span><a href="https://wordpress.org/support/view/plugin-reviews/wd-instagram-feed?filter=5" target="_blank">' . __('Sure! I\'d love to!', $this->prefix) . '</a></li>
    ...
    $notices['one_week_support'] = array(
      ...
      'link' => '<li><span class="dashicons dashicons-media-text"></span><a target="_blank" href="https://web-dorado.com/wordpress-instagram-feed-wd/installation-and-configuration/installation.html">' . __('Check out User Guide', $this->prefix) . '</a></li>
                <li><span class="dashicons dashicons-sos"></span><a target="_blank" href="https://web-dorado.com/forum/wordpress-instagram-feed-wd.html">' . __('Get Some Help', $this->prefix) . '</a></li>
